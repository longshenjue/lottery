(function(g, d) {
    function h(a) {
        ...
        this.A = {
            kiana: {
                ...
                j: {
                    click: "去死去死去死去死;快看快看，我抽到了什么~;主人，人家钱包都空了;变态！;Kiana，变身！;嗯，miHoYo什么的，最讨厌了~;千万别小看我哟~;要加油哦;我就知道主人最疼人家啦~;锵锵~;烦死啦，走开走开啦！".split(";"),
                    drag: ["呀~~"],
                    hover: ["点我抽奖哦~~"]
                },
                e: {},
    ...
    h.prototype = {
        ...
        I: function(a, c) {
            ...
            if (a && this.A[a]) {
                ...
                "pc" == this.g && (this.a.b.on("mouseenter.bhxy",
                    function() {
                        b.t = !0;
                        b.f <= b.i && "click" != b.m && b.change("hover") , b.j("hover", "hover");
                        b.q.show()
        ...
        j: function(a, c) {
            ...
            if (e === 1) {
                if (window.ajaxStart == 1) {return false;}
                window.ajaxStart = 1;
                $.ajax({
                    type: 'GET',
                    url: '/lottery/show-getcard?suc=1',
                    data: {},
                    dataType:'json',
...
preloadList = '/lottery/plugins/kiana/img/kiana-1.png /lottery/plugins/kiana/img/kiana-2.png /lottery/plugins/kiana/img/kiana-3.gif /lottery/plugins/kiana/img/kiana-4.png'.split(' ');
for (i = 0; i < preloadList.length; i++) img = new Image,
    img.src = preloadList[i];
preloadListaud = '/lottery/plugins/kiana/voice/kiana_1.mp3 /lottery/plugins/kiana/voice/kiana_2.mp3 /lottery/plugins/kiana/voice/kiana_3.mp3 /lottery/plugins/kiana/voice/kiana_4.mp3 /lottery/plugins/kiana/voice/kiana_5.mp3 /lottery/plugins/kiana/voice/kiana_6.mp3 /lottery/plugins/kiana/voice/kiana_7.mp3 /lottery/plugins/kiana/voice/kiana_8.mp3 /lottery/plugins/kiana/voice/kiana_9.mp3 /lottery/plugins/kiana/voice/kiana_10.mp3 /lottery/plugins/kiana/voice/kiana_11.mp3 /lottery/plugins/kiana/voice/kiana_drag.mp3'.split(' ');
